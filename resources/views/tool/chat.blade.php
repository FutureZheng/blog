<html><head>
    ...
    <link href="{{ asset('css/chat/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('css/chat/style.css') }}" rel="stylesheet">
    <!-- Include these three JS files: -->
    <script type="text/javascript" src="{{ asset('js/chat/swfobject.js') }}"></script>
    <script type="text/javascript" src="{{ asset('js/chat/web_socket.js') }}"></script>
    ...
    <script type="text/javascript">
        ...
        function connect() {
            // 创建websocket
            ws = new WebSocket("ws://192.168.67.90:8555");
            // 当socket连接打开时，输入用户名
            ws.onopen = onopen;
            // 当有消息时根据消息类型显示不同信息
        ...
        function onmessage(e)
        {
            ...
            switch(data['type'].toLowerCase()){     //将字符串转化为小写
                // 服务端ping客户端
                case 'ping':
                    ws.send('{"type":"pong"}');
                    break;
...
<div class="container">
    <div class="row clearfix">
        ...
        <div class="col-md-3 column">
            ...
            {{--<a href="http://workerman.net:8383" target="_blank"><img style="width:252px;margin-left:5px;" src="{{ asset('images/chat/workerman-todpole.png') }}"></a>--}}
        </div>
    </div>
</div>
