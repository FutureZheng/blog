    ...
    <form method="post" action="{{ url('admin/user/update', $user->id) }}">
        ...
        <table class="add_tab">
            ...
            <tr>
                ...
                <td>
                    <input type="text" value="{{ $user->username }}" placeholder="请输入您的用户名" name="username">
            ...
            <tr>
                ...
                <td>
                    <input type="text" value="{{ $user->email }}" placeholder="请输入您的邮箱" name="email">
            ...
            <tr>
                ...
                <td>
                    <input type="text" placeholder="请输入您的密码" name="old_password">
                </td>
            </tr>
            <tr>
