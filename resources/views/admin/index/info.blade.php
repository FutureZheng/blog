...
<div class="crumb_warp">
    ...
    <i class="fa fa-home"></i> <a href="#">首页</a>&raquo; <a href="#">系统信息</a>
</div>
<!--面包屑导航 结束-->
...
<div class="result_wrap">
    ...
    <div class="result_content">
        <div class="short_wrap">
            <a href="{{ asset('admin/article/add') }}"><i class="fa fa-plus"></i>新增文章</a>
...
<div class="result_wrap">
    ...
    <div class="result_content">
        <ul>
            <li>
                {{-- 这边本地是是有OS这个变量，但是linux没有这个变量 --}}
                <label>操作系统</label><span>{{ isset($_SERVER['OS'])? $_SERVER['OS'] : '' }}</span>
            </li>
            <li>
                <label>运行环境</label><span>{{ $_SERVER['SERVER_SOFTWARE'] }}</span>
            </li>
            <li>
                <label>PHP运行方式</label><span>{{ $_SERVER['REQUEST_METHOD'] }}</span>
            </li>
            <li>
